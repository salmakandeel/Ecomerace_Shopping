    ...
    return (
        <footer className='style-2'>
                ...
                <div className="container">
                    <div className="row g-4 row-cols-lg-2 row-cols-1  row-cols-xl-4 align-item-center">
                        {/* address List */}
                        <div className="col">
            ...
            <div className="footer-bottom">
                <div className="container">
                    <div className="section-wrapper">
                        <p>&copy; 2023 <Link to="/">Shop Cart</Link>
                        Designed by <a href="/" target='_blank'>XYZ</a>
                        </p>
